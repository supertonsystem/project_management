    ...
    return a.prototype = {
        constructor: a, setStartDate: function (e) {
            ...
            var i = "left" == a ? this.leftCalendar : this.rightCalendar, s = i.month.month(), n = i.month.year(),
                ...
                f = t(c).subtract(1, "month").year(), p = t([f, m]).daysInMonth(), u = c.day(), i = [];
            ...
            if (this.showDropdowns) {
                for (var M = i[1][1].month(), x = i[1][1].year(), I = b && b.year() || x + 5, L = C && C.year() || x - 50, S = x == L, A = x == I, _ = '<select class="monthselect">', B = 0; 12 > B; B++) _ += (!S || B >= C.month()) && (!A || B <= b.month()) ? "<option value='" + B + "'" + (B === M ? " selected='selected'" : "") + ">" + this.locale.monthNames[B] + "</option>" : "<option value='" + B + "'" + (B === M ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[B] + "</option>";
                _ += "</select>";
                for (var E = '<select class="yearselect">', W = L; I >= W; W++) E += '<option value="' + W + '"' + (W === x ? ' selected="selected"' : "") + ">" + W + "</option>";
                E += "</select>", P = _ + E
            }
            ...
            if ("right" != t || this.endDate) {
                ...
                for (var h = this.timePicker24Hour ? 0 : 1, o = this.timePicker24Hour ? 23 : 12, l = h; o >= l; l++) {
                    var c = l;
                ...
                for (var l = 0; 60 > l; l += this.timePickerIncrement) {
                    var f = 10 > l ? "0" + l : l, d = a.clone().minute(l), m = !1;
                ...
                if (e += "</select> ", this.timePickerSeconds) {
                    ...
                    for (var l = 0; 60 > l; l++) {
                        var f = 10 > l ? "0" + l : l, d = a.clone().second(l), m = !1;
            ...
            if (e(t.target).hasClass("available")) {
                ...
                this.endDate || this.container.find(".calendar td").each(function (t, a) {
                    if (!e(a).hasClass("week")) {
                        var i = e(a).attr("data-title"), s = i.substr(1, 1), n = i.substr(3, 1),
                            c = e(a).parents(".calendar"), d = c.hasClass("left") ? h.calendar[s][n] : o.calendar[s][n];

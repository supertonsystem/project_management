...
import com.suteng.shiro.business.enums.UserGenderEnum;
import com.suteng.shiro.business.enums.UserStatusEnum;
import com.suteng.shiro.business.enums.UserTypeEnum;
import com.suteng.shiro.framework.object.AbstractBO;
...
public class User extends AbstractBO {
    ...
    public String getDepName(){
        if(this.sysUser==null||this.sysUser.getDepartment()==null){
            return "";
        }
        return this.sysUser.getDepartment().getName();
    }
    public void setDepId(Integer depId){
        this.sysUser.setDepId(depId);
    }
    public Integer getDepId(){
       return this.sysUser.getDepId();
    }

    public void setPost(Integer position){
        this.sysUser.setPost(position);
    }

    public Integer getPost(){
        return this.sysUser.getPost();
